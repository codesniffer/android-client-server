package com.example.mahmud.medicaliot;
...
class Sender{
    ...
    void sendData(String serverIP, int serverPort, int size) throws InterruptedException {
        ...
        System.out.println("Inside sendData Method");
    ...
    class SenderWorker  implements Runnable  {
        ...
        public void run() {
            try {
                ...
                Log.i("mIoT", "Response from Server: " + response +"; Time to receive: " + (int) (estimatedTime / 1000000) + " ms");
